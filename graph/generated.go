...
func (ec *executionContext) field_Mutation_createJobListing_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateJobListingInput2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐCreateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateJobListing_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐUpdateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNJobListing2ᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListing(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDeleteJobListingResponse2ᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐDeleteJobListingResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_jobs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.JobListing)
	fc.Result = res
	return ec.marshalNJobListing2ᚕᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListingᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v any) (model.CreateJobListingInput, error) {
	res, err := ec.unmarshalInputCreateJobListingInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteJobListingResponse2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐDeleteJobListingResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteJobListingResponse) graphql.Marshaler {
	return ec._DeleteJobListingResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteJobListingResponse2ᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐDeleteJobListingResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteJobListingResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
	return ec._JobListing(ctx, sel, &v)
}

func (ec *executionContext) marshalNJobListing2ᚕᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.JobListing) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJobListing2ᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNJobListing2ᚖgithubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v *model.JobListing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋdracuxanᚋjobᚑlistingᚑapiᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v any) (model.UpdateJobListingInput, error) {
